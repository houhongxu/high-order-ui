...
function getCreatedRoot(props?: { container?: HTMLDivElement }) {
  console.log(props)
  ...
  const router = createBrowserRouter(
    ...
    props
      ? {
          ...
          // @ts-ignore
          basename: window.__POWERED_BY_QIANKUN__ ? '/hou' : '/',
        }
      : {},
  )

  getCreatedRoot(props).render(
